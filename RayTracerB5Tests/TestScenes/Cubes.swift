...
class Cubes: XCTestCase {
    ...
    func testTable() {
        ...
        camera.transform = Matrix.viewTransform(from: Point(x: 8, y: 6, z: -8),
        ...
        let floor = Cube()
        floor.transform = Matrix.scaling(x: 20, y: 7, z: 20) *
                            Matrix.translation(x: 0, y: 1, z: 0)
        ...
        floor.material.pattern?.transform =
                            Matrix.scaling(x: 0.07, y: 0.07, z: 0.07)
        ...
        let walls = Cube()
        walls.transform = Matrix.scaling(x: 10, y: 10, z: 10)
        ...
        walls.material.pattern?.transform =
                            Matrix.scaling(x: 0.05, y: 20, z: 0.05)
        ...
        let top = Cube()
        top.transform = Matrix.translation(x: 0, y: 3.1, z: 0) *
                        Matrix.scaling(x: 3, y: 0.1, z: 2)
        ...
        top.material.pattern?.transform =
                            Matrix.scaling(x: 0.05, y: 0.05, z: 0.05) *
                            Matrix.rotation_y(r: 0.1)
        ...
        let leg1 = Cube()
        leg1.transform = Matrix.translation(x: 2.7, y: 1.5, z: -1.7) *
                        Matrix.scaling(x: 0.1, y: 1.5, z: 0.1)
        ...
        let leg2 = Cube()
        leg2.transform = Matrix.translation(x: 2.7, y: 1.5, z: 1.7) *
            Matrix.scaling(x: 0.1, y: 1.5, z: 0.1)
        ...
        let leg3 = Cube()
        leg3.transform = Matrix.translation(x: -2.7, y: 1.5, z: -1.7) *
            Matrix.scaling(x: 0.1, y: 1.5, z: 0.1)
        ...
        let leg4 = Cube()
        leg4.transform = Matrix.translation(x: -2.7, y: 1.5, z: 1.7) *
            Matrix.scaling(x: 0.1, y: 1.5, z: 0.1)
        ...
        let glass = Cube()
        glass.transform = Matrix.translation(x: 0, y: 3.45001, z: 0) *
                            Matrix.rotation_y(r: 0.2) *
        ...
        let small1 = Cube()
        small1.transform = Matrix.translation(x: 1, y: 3.35, z: -0.9) *
            Matrix.rotation_y(r: -0.4) *
            Matrix.scaling(x: 0.15, y: 0.15, z: 0.15)
        ...
        let small2 = Cube()
        small2.transform = Matrix.translation(x: -1.5, y: 3.27, z: 0.3) *
            Matrix.rotation_y(r: 0.4) *
            Matrix.scaling(x: 0.15, y: 0.07, z: 0.15)
        small2.material.color = Color(r: 1, g: 1, b: 0.5)
        world.objects.append(small2)
        
        let small3 = Cube()
        small3.transform = Matrix.translation(x: 0, y: 3.25, z: 1) *
            Matrix.rotation_y(r: 0.4) *
            Matrix.scaling(x: 0.2, y: 0.05, z: 0.05)
        small3.material.color = Color(r: 0.5, g: 1, b: 0.5)
        world.objects.append(small3)
        
        let small4 = Cube()
        small4.transform = Matrix.translation(x: -0.6, y: 3.4, z: -1) *
            Matrix.rotation_y(r: 0.8) *
            Matrix.scaling(x: 0.05, y: 0.2, z: 0.05)
        small4.material.color = Color(r: 0.5, g: 0.5, b: 1)
        world.objects.append(small4)
        
        let small5 = Cube()
        small5.transform = Matrix.translation(x: 2, y: 3.4, z: 1) *
            Matrix.rotation_y(r: 0.8) *
            Matrix.scaling(x: 0.05, y: 0.2, z: 0.05)
        ...
        mirrorFrame.transform = Matrix.translation(x: -2, y: 3.5, z: 9.95) *
            Matrix.scaling(x: 5, y: 1.5, z: 0.05)
        ...
        let mirror = Cube()
        mirror.transform = Matrix.translation(x: -2, y: 3.5, z: 9.95) *
            Matrix.scaling(x: 4.8, y: 1.4, z: 0.06)
