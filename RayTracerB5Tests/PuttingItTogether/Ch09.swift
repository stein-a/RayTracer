...
class Ch09: XCTestCase {
    ...
    func testPuttingItTogether() {
        ...
        let backdrop = Plane()
        backdrop.transform = Matrix4.rotation_x(r: .pi/2) * Matrix4.translation(x: 0, y: 0, z: 20)
        backdrop.material = Material()
        backdrop.material.color = Color(r: 0.5, g: 0.45, b: 0.45)
        ...
        try! ppm.write(to: URL(fileURLWithPath: "B5Chapter9.ppm"), atomically: true, encoding: .utf8)
