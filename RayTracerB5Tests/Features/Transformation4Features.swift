...
class Transformation4Features: XCTestCase {
    ...
    func testReflectionIsScalingByANegativeValue() {
        let transform = Matrix4.scaling(x: -1, y: 1, z: 1)
    ...
    func testRotatingAPointAroundTheXAxis() {
        ...
        let half_quarter = Matrix4.rotation_x(r: .pi/4)
        let full_quarter = Matrix4.rotation_x(r: .pi/2)
    ...
    func testRotatingAPointAroundTheYAxis() {
        ...
        let half_quarter = Matrix4.rotation_y(r: .pi/4)
        let full_quarter = Matrix4.rotation_y(r: .pi/2)
    ...
    func testRotatingAPointAroundTheZAxis() {
        let p = Point(x: 0, y: 1, z: 0)
        let half_quarter = Matrix4.rotation_z(r: .pi/4)
        let full_quarter = Matrix4.rotation_z(r: .pi/2)
    ...
    func testShearingMovesXInProportionToY() {
        let transform = Matrix4.shearing(xy: 1, xz: 0, yx: 0, yz: 0, zx: 0, zy: 0)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testShearingMovesXInProportionToZ() {
        let transform = Matrix4.shearing(xy: 0, xz: 1, yx: 0, yz: 0, zx: 0, zy: 0)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testShearingMovesYInProportionToX() {
        let transform = Matrix4.shearing(xy: 0, xz: 0, yx: 1, yz: 0, zx: 0, zy: 0)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testShearingMovesYInProportionToZ() {
        let transform = Matrix4.shearing(xy: 0, xz: 0, yx: 0, yz: 1, zx: 0, zy: 0)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testShearingMovesZInProportionToX() {
        let transform = Matrix4.shearing(xy: 0, xz: 0, yx: 0, yz: 0, zx: 1, zy: 0)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testShearingMovesZInProportionToY() {
        let transform = Matrix4.shearing(xy: 0, xz: 0, yx: 0, yz: 0, zx: 0, zy: 1)
        let p = Point(x: 2, y: 3, z: 4)
    ...
    func testIndividualTransformationsAreAppliedInSequence() {
        ...
        let A = Matrix4.rotation_x(r: .pi/2)
        let B = Matrix4.scaling(x: 5, y: 5, z: 5)
        let C = Matrix4.translation(x: 10, y: 5, z: 7)
        let p2 = A * p
    ...
    func testTheTransformationMatrixForTheDefaultOrientation() {
        ...
        let t = Matrix4.viewTransform(from: from, to: to, up: up)
        
        XCTAssert(t == Matrix4.identity())
    }
    ...
    func testAViewTransformationMatrixLookingInThePositiveZDirection() {
        ...
        let t = Matrix4.viewTransform(from: from, to: to, up: up)
        XCTAssert(t == Matrix4.scaling(x: -1, y: 1, z: -1))
    }
    ...
    func testTheViewTransformationMovesTheWorld() {
        ...
        XCTAssert(t == Matrix4.translation(x: 0, y: 0, z: -8))
    }
