...
"""
    ...
    func testTrianglesInGroups() {
        let file = try! String.init(contentsOfFile: "/Users/salver/development/Raytracer/Raytracer/RayTracerB5Tests/OBJfiles/triangles.obj", encoding: .utf8)
        let parser = Parser()
        parser.parseObj(file: file)
...
"""
    ...
    func testProcessingAnOBJFileWithATeapot() {
        let file = try! String.init(contentsOfFile: "/Users/salver/development/Raytracer/Raytracer/RayTracerB5Tests/OBJfiles/teapot.obj", encoding: .utf8)
        let parser = Parser()
        parser.parseObj(file: file)
    ...
    func testProcessingAnOBJFileWithABigTeapot() {
        let file = try! String.init(contentsOfFile: "/Users/salver/development/Raytracer/Raytracer/RayTracerB5Tests/OBJfiles/bigteapot.obj", encoding: .utf8)
        let parser = Parser()
        parser.parseObj(file: file)
